...
**(3) 추천 점수 + 유사도 기반 추천 결과**

- **tfidf = TfidfVectorizer(stop_words='english', min_df=5)**

*텍스트를 숫자 벡터로 변환하는 도구

  - stop_words : the, is, and 같은 의미 없는 용어 제거
  - min_df=5 : 5개 미만으로 등장한 단어는 무시 (희귀한 단어 제거)

- **cosine_similarity**

  코사인 유사도: 어떤 단어들을 비슷한 비율로 사용하고 있는가를 분석
...
시각화 종류가 많아서 다양하게 학습할 수 있었고, 텍스트를 숫자 벡터로 바꾸는 벡터화 함수에 대해 배울 수 있어서 좋았다!
