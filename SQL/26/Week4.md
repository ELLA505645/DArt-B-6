...
*실무에서는 현실적으로 인덱스 없이 데이터베이스 운영이 불가능하다
- 클러스터형 인덱스: 기본 키로 저장하면 자동 생성됨 (테이블에 1개만 만들 수 있음)
- 보조 인덱스: 고유 키로 지정하면 자동 생성됨 (여러개를 만들 수 있지만 자동 정렬 되지는 않음)
...
```
4️⃣번, NOT NULL은 조건일 뿐 인덱스를 자동으로 생성하지 않음. 
```
...
<img width="1119" height="845" alt="image" src="https://github.com/user-attachments/assets/782e860e-db73-4fa7-adcb-a8c5118e2e6e" />
<img width="1153" height="864" alt="image" src="https://github.com/user-attachments/assets/308d4c24-180a-4e0d-8485-b47373ebe74f" />
...
<img width="1163" height="875" alt="image" src="https://github.com/user-attachments/assets/e91b130c-7cab-478f-a969-5ce9469b164c" />
<img width="1148" height="862" alt="image" src="https://github.com/user-attachments/assets/9bfb854e-7a15-4374-b5ee-47232bafc120" />
<img width="1146" height="855" alt="image" src="https://github.com/user-attachments/assets/63f5cc96-d9c4-4f66-b5c7-bce5dc19fca5" />
<img width="1128" height="869" alt="image" src="https://github.com/user-attachments/assets/54cb0798-4541-4adf-974e-6e4f594010ea" />
